...
def launch_setup(context, *args, **kwargs):
    ...
    # 1. Konum Kontrolcüsü (Varsayılan olarak AKTİF başlar)
    ...
    # 2. Hız Kontrolcüsü (İNAKTİF başlar, tetiklenmeyi bekler)
    ...
    # 3. Tork Kontrolcüsü (İNAKTİF başlar, tetiklenmeyi bekler)
