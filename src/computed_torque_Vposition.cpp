...
public:
    ComputedTorqueController() : Node("computed_torque_node"), data_received_(false)
    {
        ...
        // --- DEĞİŞTİRİLEN KISIM: Yana Yatmış "V" Şekli ve Karşıya Bakan Uç Nokta ---
        // J1:0, J2:-60°, J3:120°, J4:-60°, J5:90°, J6:0°
        q_d_ << 0.0, -M_PI/3.0, 2.0*M_PI/3.0, -M_PI/3.0, M_PI/2.0, 0.0;
        ...
        RCLCPP_INFO(this->get_logger(), "C++ Computed Torque Kontrolcüsü Başlatıldı! Hedef: V-Pozisyonu");
    }
